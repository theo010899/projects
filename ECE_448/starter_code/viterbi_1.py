...
def viterbi_1(train, test):
    ...
    '''
## num = (# times you see (t,w)) + smoothing  / den = [# times you see t] + smoothing*( len(emission[t]) )
## alpha value =  10^-3, 10^-4 tends to work well
    tags = {}
    ...
    for cur_tag in tag_word:
        for cur_word in tag_word[cur_tag]:
            ...
            laplace_denom = tag_count + smoothing_parameter * (len(tag_word[cur_tag]) + 1)
